...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Our Office",
      details: ["123 Business Avenue", "Financial District", "New York, NY 10001"]
    },
    {
      icon: Phone,
      title: "Phone",
  ...
  return (
    <section id="contact" className="relative py-24 overflow-hidden bg-secondary/50 dark:bg-secondary/20">
      ...
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 reveal">
            Let's Discuss Your <span className="heading-gradient">Financial Needs</span>
          </h2>
          <p className="text-foreground/80 reveal">
            Contact us today to schedule a consultation with one of our financial experts.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2 space-y-8">
            {contactInfo.map((item, index) => (
              <div key={index} className="flex glass-panel p-6 rounded-xl reveal" style={{ transitionDelay: `${index * 100}ms` }}>
                <div className="mr-6">
